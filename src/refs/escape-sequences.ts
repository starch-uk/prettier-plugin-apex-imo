/**
 * Complete list of Apex escape sequences
 * Reference: https://help.salesforce.com/s/articleView?language=en_US&id=analytics.bi_security_datasets_predicate_escapesequences.htm&type=5
 * Apex uses Java-like escape sequences for string literals
 * This file contains all escape sequences that can appear in Apex string literals
 */
...
export const ESCAPE_SEQUENCES: Record<string, string> = Object.fromEntries(
 ...
 */
export const ESCAPE_SEQUENCE_PATTERNS: readonly string[] = Object.keys(
	ESCAPE_SEQUENCES,
) as readonly string[];
 ...
 */
export const ALL_ESCAPE_SEQUENCE_REGEX = /\\([ntrbf\\'"]|u[0-9a-fA-F]{4})/g;
 ...
 */
export function containsEscapeSequence(text: string): boolean {
 ...
 */
export function findEscapeSequences(text: string): string[] {
 ...
 */
export function isValidEscapeSequences(text: string): boolean {
 ...
 */
export const REGEX_METACHARACTERS_PATTERN = /[.*+?^${}()|[\]\\]/g;
 ...
 */
export function escapeRegexMetacharacters(text: string): string {
