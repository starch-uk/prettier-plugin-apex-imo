...
describe('apexdoc', () => {
	...
	describe('findApexDocCodeBlocks', () => {
		...
		it('should handle code blocks with asterisks in comment lines', () => {
		...
		it('should handle nested braces in code blocks', () => {
		...
		it('should skip invalid code blocks with unmatched braces', () => {
		...
		it('should handle code block at start of text (no newlines before)', () => {
		...
		it('should handle code block when skipWhitespace returns false', () => {
		...
		it('should handle code block when codeStart >= text.length', () => {
		...
		it('should handle code block when skipWhitespace returns false at end of comment', () => {
		...
		it('should handle code block when codeStart is false (skipWhitespace returns false)', () => {
		...
		it('should handle code block when codeStart equals text.length (triggers line 59)', () => {
		...
		it('should handle code block when codeStart >= text.length with trailing whitespace', () => {
		...
		it('should handle code block when codeStart >= text.length at boundary', () => {
		...
		it('should not find code blocks in regular comments', () => {
	...
	describe('formatCodeBlock', () => {
		...
		it('should format regular code blocks', async () => {
			const input = loadFixture('apexdoc-single-line-code', 'input');
		...
		it('should format annotation code blocks', async () => {
		...
		it('should use apexPlugin when plugin is undefined', async () => {
		...
		it('should use apexPlugin when plugin is null', async () => {
		...
		it('should handle useTabs option when undefined', async () => {
			const code = loadFixture('formatcodeblock-simple-integer', 'input');
			const expected = loadFixture(
				'formatcodeblock-simple-integer',
				'output',
		...
		it('should handle useTabs option when true', async () => {
			const code = loadFixture('formatcodeblock-simple-integer', 'input');
			const expected = loadFixture(
				'formatcodeblock-simple-integer',
				'output',
		...
		it('should handle useTabs option when false', async () => {
			const code = loadFixture('formatcodeblock-simple-integer', 'input');
			const expected = loadFixture(
				'formatcodeblock-simple-integer',
				'output',
		...
		it('should extract annotation code correctly when class is not found', async () => {
		...
		it('should handle annotation code extraction when formatted output lacks class', async () => {
		...
		it('should handle extractAnnotationCode else path when class not found in lines', async () => {
			// Test the else path in extractAnnotationCode when foundClass is false
		...
		it('should handle extractAnnotationCode when formatted output lacks expected class structure', async () => {
		...
		it('should handle multi-line annotation code', async () => {
			const code = loadFixture(
		...
		it('should handle multi-line method code', async () => {
			const input = loadFixture('apexdoc-multi-line-code', 'input');
			const expected = loadFixture(
		...
		it('should handle code with different tabWidth', async () => {
			const code = loadFixture('formatcodeblock-simple-integer', 'input');
			const expected = loadFixture(
				'formatcodeblock-simple-integer',
				'output',
		...
		it('should handle code with different printWidth', async () => {
			const code = loadFixture('formatcodeblock-simple-integer', 'input');
			const expected = loadFixture(
				'formatcodeblock-simple-integer',
				'output',
